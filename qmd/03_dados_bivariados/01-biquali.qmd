...
A base de dados está disponível em: [Entrevista_municipes.csv](https://github.com/FCopf/visualizacao-de-dados/blob/main/datasets/Entrevista_municipes.csv){target="_blank"}
...
Após entrevistar `r n` pessoas selecionadas ao acaso de uma lista da moradores da cidade, é construída uma tabela com três colunas: `Entrevistado` (sequência numérica do primeiro ao último respondente), `Opinião` e `Moradia`. 

Importe a base de dados [Entrevista_municipes.csv](https://github.com/FCopf/visualizacao-de-dados/blob/main/datasets/Entrevista_municipes.csv){target="_blank"} para ver a tabela.
