...
Importe a base de dados [medley.csv](https://github.com/FCopf/probest-cambientais/blob/master/datasets/medley.csv) (disponível também em [aqui](https://users.monash.edu.au/~murray/BDAR/){target="_blank"}) que avalia o impacto da presença de metais pesados na diversidade de espécies de diatomácias em riachos (@medleyclements1998; @queen2002experimental; @logan2011biostatistical).
...
## Voltando ao conjundo de dados `medley.csv`
