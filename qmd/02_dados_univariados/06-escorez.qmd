...
2. **Padronização**: ao dividirmos a quantia $X_i - \overline{X}$ pelo desvio padrão de $X$ obtemos a nova variável denominada $Z$. O termo padronização refere-se ao fato do desvio padrão de $Z$ ser igual a $1$.
