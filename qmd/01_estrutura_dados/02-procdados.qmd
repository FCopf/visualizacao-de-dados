...
+ Após criar o diretório copie para dentro dele a base de dados `Reservatorios_Parana_parcial.csv`. A base está disponível no link do [GitHub](https://github.com/FCopf/visualizacao-de-dados/blob/main/datasets/Reservatorios_Parana_parcial.csv). Após acessar o link, a janela de seu navegador irá mostrar um arquivo texto com os dados da planilha. Estes são os mesmos dados que apresentamos no @sec-estrdados.
